...
export default function CSSTypingChallengePage() {
        ...
        <Card className="max-w-2xl text-center">
          <CardHeader>
            ...
            <CardDescription className="mt-4 text-lg text-muted-foreground">
              Test your speed and accuracy by typing real CSS snippets against the clock. Type the code exactly as you see it. Ready to test your might?
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="container py-12 flex items-center justify-center">
        <Card className="max-w-2xl text-center animate-in fade-in zoom-in-95">
          <CardHeader>
            ...
            <CardDescription className="mt-4 text-lg text-muted-foreground">
              You've successfully completed the CSS Code Rush. Great job!
            </CardDescription>
          </CardHeader>
