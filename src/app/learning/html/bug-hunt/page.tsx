...
const puzzles = [
  {
    ...
    description: 'This heading tag is not closed properly. Find the mistake and fix it.',
    brokenCode: '<h1>Welcome to Bug Hunt!</h2>',
    correctCode: '<h1>Welcome to Bug Hunt!</h1>',
    bugs: 1,
    timeLimit: 30,
  },
  {
    level: 2,
    title: 'Broken Image',
    description: 'This image is supposed to show a placeholder, but the source attribute is misspelled.',
    brokenCode: '<img scc="https://picsum.photos/seed/bug/400/100" alt="A random placeholder">',
    correctCode: '<img src="https://picsum.photos/seed/bug/400/100" alt="A random placeholder">',
    bugs: 1,
    timeLimit: 30,
  },
  {
    level: 3,
    title: 'Unclosed List',
    description: 'This unordered list is missing a closing tag. Can you spot it and add it?',
    brokenCode: '<ul>\n  <li>First bug</li>\n  <li>Second bug</li>',
    correctCode: '<ul>\n  <li>First bug</li>\n  <li>Second bug</li>\n</ul>',
    bugs: 1,
    timeLimit: 40,
  },
  {
    ...
    description: 'This anchor tag is trying to be a link, but its most important attribute is missing.',
    brokenCode: '<a>Click me</a>',
    correctCode: '<a href="#">Click me</a>',
    bugs: 1,
    timeLimit: 35,
  },
  {
    level: 5,
    title: 'A Messy Form',
    description: 'This form has multiple bugs! A missing closing tag, a wrong attribute, and an unclosed input. Fix them all!',
...
export default function HTMLBugHuntPage() {
        ...
        <Card className="max-w-2xl text-center">
          <CardHeader>
            ...
            <CardDescription className="mt-4 text-lg text-muted-foreground">
              Find and fix the errors in broken HTML code snippets before the timer runs out. Ready to debug?
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="sticky top-20">
            <Card className="shadow-lg">
                ...
                <CardContent>
                    <div className="border rounded-md p-4 bg-background/50 min-h-[250px] prose prose-invert prose-headings:text-foreground prose-p:text-muted-foreground prose-a:text-primary">
