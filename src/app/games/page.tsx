...
const newGames = [
  ...
  },
  {
    ...
    href: '/games/shadows-of-the-knight',
    disabled: false,
  },
  {
    name: 'Power of Thor',
    description: 'Prove your worthiness by solving Odin’s coding trials to regain control of Mjolnir.',
